...
I've spent a lot (and by a lot I mean A LOT) of time over the years picking the flashiest Linux distribution and the most convoluted [IDEs](https://www.redhat.com/en/topics/middleware/what-is-ide) but this time I've decided to just keep things simple and let my work do the flashing.

I've picked the airtight combo of Linux Mint, Google Chrome (for developer tools; I still use Edge for browsing and beta testing), and VScode for my learning environment. It doesn't get any more vanilla than this.
